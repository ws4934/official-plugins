...
type HostCallDemoRes struct {
	...
	PluginID   string                  `json:"pluginId" dc:"The unique identifier of the current plugin" eg:"plugin-demo-dynamic"`
